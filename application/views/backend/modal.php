	...
	function quarantine_modal(delete_url){
		jQuery('#modal-20').modal('show', {backdrop: 'static'});
		document.getElementById('delete_link20').setAttribute('href' , delete_url);
	}
	</script>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:left;"><strong style="color:#FFFFFF">Head Up!</strong></h4>
                </div>
				...
				<div class="row">
				 <div class="col-sm-7">	
					Are you sure you want to quarantine this student ?
				</div>
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-success btn-rounded btn-sm" id="delete_link20"><i class="fa fa-check">&nbsp;</i>Yes</a>
	...
	<div class="modal fade" id="modal-6">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
				...
				<div class="row">
				 <div class="col-sm-7">	
					Are you sure you want to unpublich exam?
				</div>
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-success btn-rounded btn-sm" id="delete_link3"><i class="fa fa-check">&nbsp;</i>Yes</a>
                    <button type="button" class="btn btn-info btn-rounded btn-sm" data-dismiss="modal"><i class="fa fa-times">&nbsp;</i>No</button>
					</div>
				</div>
				</div>
