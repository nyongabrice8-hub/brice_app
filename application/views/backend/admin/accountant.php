...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/printAccountantInformation/<?php echo $accountant['accountant_id'];?>/accountantName=<?php echo $accountant['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
