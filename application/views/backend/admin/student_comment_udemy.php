			...
			<div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('enter_remarks_for'); ?> : <?=$this->crud_model->get_type_name_by_id('student', $student_id);?></div>
				...
				<?php echo form_open(base_url() . $this->session->userdata('login_type').'/udemy_stu_rem/save/' , array('class' => 'form-horizontal form-goups-bordered validate'));?>
					...
					<div class="form-group">
                 		<label class="col-md-12" for="example-text"><?php echo get_phrase('class_teacher\'s_comment');?> <b style="color:red">*</b></label>
                    		<div class="col-sm-12">
					...
					<div class="form-group">
                 		<label class="col-md-12" for="example-text"><?php echo get_phrase('class_teacher\'s_name');?> <b style="color:red">*</b></label>
                    		<div class="col-sm-12">
					...
					<div class="form-group">
                 		<label class="col-md-12" for="example-text"><?php echo get_phrase('head_teacher\'s_comment');?> <b style="color:red">*</b></label>
                    		<div class="col-sm-12">
